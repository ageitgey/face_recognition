...
class Test_face_recognition(unittest.TestCase):
    def test_knn1(self):
        ...
        assert("obama" in face_recognition_knn.predict(join("test_images_knn/test", "obama1.jpg"), knn_clf=knn_clf)[0])

        assert("alex_lacamoire" in face_recognition_knn.predict(join("test_images_knn/test", "alex_lacamoire1.jpg"), knn_clf=knn_clf)[0])
    ...
    def test_knn_pickle(self):
        ...
        try:
            ...
            assert("alex_lacamoire" in face_recognition_knn.predict(join("test_images_knn/test", "alex_lacamoire1.jpg"), model_save_path=pickle_path)[0])
