...
from face_recognition import api, face_detection_cli, face_recognition_cli


class Test_face_recognition(unittest.TestCase):
    def test_load_image_file(self):
        img = api.load_image_file(
            os.path.join(os.path.dirname(__file__), "test_images", "obama.jpg")
        )
        self.assertEqual(img.shape, (1137, 910, 3))

    def test_load_image_file_32bit(self):
        img = api.load_image_file(
            os.path.join(os.path.dirname(__file__), "test_images", "32bit.png")
        )
    ...
    def test_partial_face_locations(self):
        img = api.load_image_file(
            os.path.join(
                os.path.dirname(__file__), "test_images", "obama_partial_face.jpg"
            )
        )
        detected_faces = api.face_locations(img)
        ...
        img = api.load_image_file(
            os.path.join(
                os.path.dirname(__file__), "test_images", "obama_partial_face2.jpg"
            )
        )
        detected_faces = api.face_locations(img)
    ...
    def test_raw_face_locations_batched(self):
        ...
        batched_detected_faces = api._raw_face_locations_batched(
            images, number_of_times_to_upsample=0
        )
    ...
    def test_face_landmarks_small_model(self):
        ...
        self.assertEqual(
            set(face_landmarks[0].keys()), set(["nose_tip", "left_eye", "right_eye"])
        )
    ...
    def test_face_distance(self):
        ...
        img_a2 = api.load_image_file(
            os.path.join(os.path.dirname(__file__), "test_images", "obama2.jpg")
        )
        img_a3 = api.load_image_file(
            os.path.join(os.path.dirname(__file__), "test_images", "obama3.jpg")
        )

        img_b1 = api.load_image_file(
            os.path.join(os.path.dirname(__file__), "test_images", "biden.jpg")
        )
    ...
    def test_command_line_interface(self):
        ...
        result = runner.invoke(
            face_recognition_cli.main, args=[image_folder, image_file]
        )
    ...
    def test_command_line_interface_big_image(self):
        ...
        image_file = os.path.join(
            os.path.dirname(__file__), "test_images", "obama3.jpg"
        )
    ...
    def test_command_line_interface_tolerance(self):
        ...
        result = runner.invoke(
            face_recognition_cli.main,
            args=[image_folder, image_file, "--tolerance", "0.55"],
        )
    ...
    def test_command_line_interface_show_distance(self):
        ...
        result = runner.invoke(
            face_recognition_cli.main,
            args=[image_folder, image_file, "--show-distance", "1"],
        )
    ...
    def test_fd_command_line_interface_hog_model(self):
        ...
        result = runner.invoke(
            face_detection_cli.main, args=[image_file, "--model", "hog"]
        )
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_string in result.output)
    ...
    def test_fd_command_line_interface_cnn_model(self):
        ...
        result = runner.invoke(
            face_detection_cli.main, args=[image_file, "--model", "cnn"]
        )
        self.assertEqual(result.exit_code, 0)
        self.assertTrue(target_string in result.output)
